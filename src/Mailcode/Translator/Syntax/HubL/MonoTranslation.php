...
/**
 * Translates the {@see Mailcode_Commands_Command_Mono} command to HubL.
 *
 * @package Mailcode
 * @subpackage Translator
 * @author Sebastian Mordziol <s.mordziol@mistralys.eu>
 */
class MonoTranslation extends BaseHubLCommandTranslation implements Mailcode_Translator_Command_Mono
{
