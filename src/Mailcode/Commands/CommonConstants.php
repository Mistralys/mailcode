...
class Mailcode_Commands_CommonConstants
{
    ...
    public const VALIDATION_MISSING_CONTENT_CLOSING_TAG = 49214;
    public const VALIDATION_UNESCAPED_NESTED_COMMAND = 49215;
    public const VALIDATION_MISSING_CONTENT_OPENING_TAG = 49216;
