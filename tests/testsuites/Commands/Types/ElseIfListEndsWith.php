...
final class Mailcode_ElseIfListEndsWithTests extends MailcodeTestCase
{
    public function test_validation_contains()
    {
        $tests = array(
            ...
            array(
                ...
                'string' => '{if: 1 == 1}{elseif list-ends-with: $FOO.PROP in: "Search"}{end}',
                'valid' => true,
                'code' => 0
            ),
            array(
                'label' => 'Valid statement case sensitive',
                'string' => '{if: 1 == 1}{elseif list-ends-with: $FOO.PROP "Search"}{end}',
                'valid' => true,
                'code' => 0
            ),
            array(
                'label' => 'Valid statement case insensitive',
                'string' => '{if: 1 == 1}{elseif list-ends-with: $FOO.PROP insensitive: "Search"}{end}',
                'valid' => true,
                'code' => 0
            ),
            array(
                'label' => 'Valid despite different order',
                'string' => '{if: 1 == 1}{elseif list-ends-with:"Search" insensitive: $FOO.PROP}{end}',
                'valid' => true,
                'code' => 0
            ),
            array(
                'label' => 'Several search terms',
                'string' => '{if: 1 == 1}{elseif list-ends-with: "Foo" "Bar" insensitive: $FOO.PROP}{end}',
                'valid' => true,
                'code' => 0
            )
        );
    ...
    {
        $cmd = Mailcode_Factory::elseIf()->listEndsWith('LIST.PROP', array("Foo"));
