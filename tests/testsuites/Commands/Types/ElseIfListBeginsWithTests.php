...
final class ElseIfListBeginsWithTests extends MailcodeTestCase
{
    public function test_validation_contains() : void
    {
        $tests = array(
            ...
            array(
                ...
                'string' => '{if: 1 == 1}{elseif list-begins-with: $FOO.PROP in: "Search"}{end}',
                'valid' => true,
                'code' => 0
            ),
            array(
                'label' => 'Valid statement case sensitive',
                'string' => '{if: 1 == 1}{elseif list-begins-with: $FOO.PROP "Search"}{end}',
                'valid' => true,
                'code' => 0
            ),
            array(
                'label' => 'Valid statement case insensitive',
                'string' => '{if: 1 == 1}{elseif list-begins-with: $FOO.PROP insensitive: "Search"}{end}',
                'valid' => true,
                'code' => 0
            ),
            array(
                'label' => 'Valid despite different order',
                'string' => '{if: 1 == 1}{elseif list-begins-with:"Search" insensitive: $FOO.PROP}{end}',
                'valid' => true,
                'code' => 0
            ),
            array(
                'label' => 'Several search terms',
                'string' => '{if: 1 == 1}{elseif list-begins-with: "Foo" "Bar" insensitive: $FOO.PROP}{end}',
                'valid' => true,
                'code' => 0
            )
        );
    ...
    {
        $cmd = Mailcode_Factory::elseIf()->listBeginsWith('LIST.PROP', array("Foo"));
