...
final class Mailcode_IfListEqualsTests extends MailcodeTestCase
{
    ...
    {
        $cmd = Mailcode_Factory::if()->listEquals('LIST.PROP', array("Foo"));
    ...
    {
        $cmd = Mailcode_Factory::if()->listEquals('LIST.PROP', array("Foo"), true);
