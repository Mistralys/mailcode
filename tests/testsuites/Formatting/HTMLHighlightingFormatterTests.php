...
final class HTMLHighlightingFormatterTests extends MailcodeTestCase
{
    private function createExampleSafeguard(): Mailcode_Parser_Safeguard
    {
        ...
        return Mailcode::create()->getParser()->createSafeguard($content);
    }
    ...
    public function test_parsing(): void
    {
        $tests = array(
            ...
            array(
                ...
                'highlighted' =>
                    Mailcode_Factory::set()->var('FOOBAR', 'Foo')->getHighlighted() .
