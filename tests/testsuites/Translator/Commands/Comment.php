    ...
    public function test_translateCommand()
    {
        ...
        $tests = array(
            array(
                ...
                'mailcode' => Mailcode_Factory::comment('Someone here'),
                'expected' => sprintf($template, 'Someone here')
            ),
            array(
                'label' => 'With quotes',
                'mailcode' => Mailcode_Factory::comment('Someone "is quoted" here'),
                'expected' => sprintf($template, 'Someone "is quoted" here')
            ),
            array(
                'label' => 'With special characters',
                'mailcode' => Mailcode_Factory::comment('insensitive: $FOOBAR (4*5/lopos)'),
