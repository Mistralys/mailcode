    ...
    public function test_translateCommand() : void
    {
        $tests = array(
            array(
                ...
                'mailcode' => Mailcode_Factory::show()->showNumber('FOO.BAR'),
                'expected' => <<<'EOD'
...
EOD
            ...
            array(
                'label' => 'No decimals',
                'mailcode' => Mailcode_Factory::show()->showNumber('FOO.BAR', '1000'),
                'expected' => <<<'EOD'
${number.format('#', $number.toNumber('#.####', $FOO.BAR.replace(',', '.'), 'en_US'), 'en_US')}
EOD
            ),
            array(
                ...
                'mailcode' => Mailcode_Factory::show()->showNumber('FOO.BAR', '1,000'),
                'expected' => <<<'EOD'
${number.format('#,###', $number.toNumber('#.####', $FOO.BAR.replace(',', '.'), 'en_US'), 'en_US')}
EOD
            ),
            array(
                ...
                'mailcode' => Mailcode_Factory::show()->showNumber('FOO.BAR', '1.000,00'),
                'expected' => <<<'EOD'
